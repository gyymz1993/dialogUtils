...
public class OneToucDialog extends DialogBase
...
//        lp.alpha=0.5f;//透明度，黑暗度为lp.dimAmount=1.0f;
    ...
    public boolean onItemSelected(
            OneToucDialog dialog, View view, int position, CharSequence text, boolean longPress) {
        if (!view.isEnabled()) {
            return false;
        }
    ...
    /**
     * Retrieves the custom view that was inflated or set to the OneToucDialog during building.
     *
    ...
    public final void setItems(@Nullable CharSequence... items) {
        if (builder.adapter == null) {
            throw new IllegalStateException(
                    "This OneToucDialog instance does not "
                ...
                new TextWatcher() {
                    ...
                    public void onTextChanged(CharSequence s, int start, int before, int count) {
                        ...
                        if (builder.alwaysCallInputCallback) {
                            builder.inputCallback.onInput(OneToucDialog.this, s);
                        }
                    }
    ...
    public interface ListCallback {
        void onSelection(OneToucDialog dialog, View itemView, int position, CharSequence text);
    }
    ...
    public interface ListLongCallback {
        boolean onLongSelection(OneToucDialog dialog, View itemView, int position, CharSequence text);
    }
    ...
    public interface ListCallbackSingleChoice {
         ...
         */
        boolean onSelection(
                OneToucDialog dialog, View itemView, int which, @Nullable CharSequence text);
    }
    ...
    public interface ListCallbackMultiChoice {
         ...
         */
        boolean onSelection(OneToucDialog dialog, Integer[] which, CharSequence[] text);
    }
    ...
    public interface SingleButtonCallback {
        void onClick(OneToucDialog dialog, DialogAction which);
    }

    public interface InputCallback {
        void onInput(OneToucDialog dialog, CharSequence input);
    }
    ...
    /**
     * The class used to construct a OneToucDialog.
     */
    ...
    public static class Builder {
        ...
        protected boolean showLodaing = false;
        ...
        public boolean isShowLodaing() {
            return showLodaing;
        }

        public Builder setShowLodaing(boolean showLodaing) {
            this.showLodaing = showLodaing;
            return this;
        }
        ...
        public static int getOneTouchType() {
            return ONE_TOUCH_TYPE;
        }
        ...
        public Builder setmWidth(double mWidth) {
            this.mWidth = mWidth;
            return this;
        }

        public Builder setmHeight(double mHeight) {
         ...
         *                      progress bar is shown that is incremented or set via the built OneToucDialog instance.
        ...
        @UiThread
        public OneToucDialog build() {
            return new OneToucDialog(this);
        }

        @UiThread
        public OneToucDialog show() {
            OneToucDialog dialog = build();
            dialog.show();
            return dialog;
        }
    }
