...
public class ColorChooserDialog extends DialogFragment
  ...
  public void onClick(View v) {
    if (v.getTag() != null) {
      ...
      final OneToucDialog dialog = (OneToucDialog) getDialog();
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    final OneToucDialog dialog = bd.build();
  ...
  private void toggleCustom(OneToucDialog dialog) {
    if (dialog == null) {
      dialog = (OneToucDialog) getDialog();
    }
