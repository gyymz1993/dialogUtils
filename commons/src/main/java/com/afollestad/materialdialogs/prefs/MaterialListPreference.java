...
public class MaterialListPreference extends ListPreference {
  ...
  public RecyclerView getRecyclerView() {
    ...
    return ((OneToucDialog) getDialog()).getRecyclerView();
  }
    ...
    OneToucDialog.Builder builder =
        new OneToucDialog.Builder(context)
            ...
            .itemsCallbackSingleChoice(
                preselect,
                new OneToucDialog.ListCallbackSingleChoice() {
                  @Override
                  public boolean onSelection(
                          OneToucDialog dialog, View itemView, int which, CharSequence text) {
